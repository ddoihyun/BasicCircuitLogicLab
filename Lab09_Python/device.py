...
class Device():
    ...
    def print_device_info(self):
        for idx in Device.idDev:
            print('-------------------------------')
            #print('Device %d'%(idx)+':'+Device.szDevName[idx].value+'\t'+Device.szSerialNum[idx].value)
            print('Device %d'%(idx)+':'+str(Device.szDevName[idx].value)+'\t'+str(Device.szSerialNum[idx].value))
